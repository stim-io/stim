...
impl ControllerState {
    pub(crate) fn new(server_base_url: impl Into<String>) -> Self {
        Self {
    ...
    pub(crate) fn cache_discovery_record(&mut self, discovery: DiscoveryRecord) {
    ...
    pub(crate) fn cached_endpoint_count(&self) -> usize {
        self.cached_discovery.len()
    }

    pub(crate) fn server_base_url(&self) -> &str {
