...
pub(crate) struct RoundtripIds {
    pub(crate) conversation_id: String,
    pub(crate) message_id: String,
    pub(crate) create_envelope_id: String,
    pub(crate) patch_envelope_id: String,
    pub(crate) fix_envelope_id: String,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct ParsedAcknowledgement {
    pub(crate) receipt_result: DeliveryReceiptResult,
    pub(crate) receipt_detail: Option<String>,
    pub(crate) ack_envelope_id: String,
    pub(crate) ack_message_id: String,
    pub(crate) ack_version: u64,
}
...
pub(crate) fn user_text_content(text: &str) -> MessageContent {
    MessageContent {
...
pub(crate) fn assistant_card_content(text: &str) -> MessageContent {
    MessageContent {
...
pub(crate) fn synthetic_response_envelope(
...
pub(crate) fn sample_roundtrip_ids(conversation_id: Option<&str>) -> RoundtripIds {
...
pub(crate) fn sample_create_envelope(
    ids: &RoundtripIds,
    text: &str,
...
pub(crate) fn sample_patch_envelope(
    ids: &RoundtripIds,
    base_version: u64,
    text: &str,
) -> MessageEnvelope {
...
pub(crate) fn sample_fix_envelope(ids: &RoundtripIds, base_version: u64) -> MessageEnvelope {
    sample_text_envelope(TextEnvelopeSample {
